...
export const IcKyc = ({ size = 20 }) => (
  <svg {...base(size)}>
    <rect x="3" y="4" width="18" height="16" rx="2" />
    <circle cx="8.5" cy="10" r="2" />
    <path d="M5.5 16c0-1.7 1.3-2.5 3-2.5s3 .8 3 2.5" />
    <path d="M14 9h5M14 12.5h5" />
  </svg>
);

export const IcStaff = ({ size = 20 }) => (
  <svg {...base(size)}>
